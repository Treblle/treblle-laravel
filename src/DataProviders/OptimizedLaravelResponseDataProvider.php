...
final class OptimizedLaravelResponseDataProvider implements ResponseDataProvider
{
    public function __construct(
        private readonly OptimizedFieldMasker $fieldMasker,
    ...
    public function getResponse(): Response
    {
        ...
        return new Response(
            ...
            headers: $this->fieldMasker->mask(
                $this->optimizeHeadersTransform($this->response->headers->all())
            ),
        );
    }
    ...
    /**
     * Optimized headers transformation using direct array manipulation instead of collections
     */
